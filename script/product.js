...
const addToCartBtn = document.querySelectorAll('[data-cart-id="${product.id}"]')
        ...
        <div class="card col-4 m-auto p-0 product-card">
            ...
            <div class="card-body">
                ...
                <div class="product-btns-box">
                    <a class="btn product-btn" data-product-id="${product.id}" data-bs-toggle="modal" data-bs-target="#detailModal">See More</a>
                    <a class="btn product-btn" onclick='addToCart(${JSON.stringify(product)})' cart-btn>Add to Cart</a>
                </div>
            </div>
        </div>
    `;
